  ...
  "rounded-xl border bg-card text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        product: "shadow-card hover:shadow-card-hover hover:-translate-y-1 overflow-hidden",
        featured: "shadow-glow border-primary/20 bg-gradient-to-br from-card to-primary/5",
      },
    },
    defaultVariants: {
      variant: "default",
