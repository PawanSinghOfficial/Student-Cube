...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    college: "MSIT",
    condition: "like-new",
    seller: { name: "rahul23", isDealer: true, isVerified: true },
  ...
  },
  {
    ...
    college: "USICT",
    condition: "good",
    seller: { name: "priya99", isDealer: false, isVerified: true },
  ...
  },
  {
    ...
    college: "MAIT",
    condition: "new",
    seller: { name: "arjun45", isDealer: true, isVerified: true },
  ...
  },
  {
    ...
    college: "BPIT",
    condition: "like-new",
    seller: { name: "sneha12", isDealer: true, isVerified: true },
  ...
  },
  {
    ...
    college: "USBT",
    condition: "new",
    seller: { name: "amit789", isDealer: false, isVerified: false },
    createdAt: "1 day ago",
    views: 89,
  },
  {
    ...
    college: "GTBIT",
    condition: "good",
    seller: { name: "neha567", isDealer: false, isVerified: true },
  ...
  },
  {
    ...
    college: "VIPS",
    condition: "like-new",
    seller: { name: "vikas34", isDealer: false, isVerified: true },
  ...
  },
  {
    ...
    college: "USICT",
    condition: "good",
    seller: { name: "tanvi88", isDealer: true, isVerified: true },
    createdAt: "2 days ago",
    views: 445,
    isFeatured: true,
  },
